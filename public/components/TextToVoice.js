...
const TextToVoice = () => {
    ...
    return (_jsx("div", { children: _jsxs(Container, { p: 4, children: [_jsx(Heading, { size: "lg", color: "pink.300", children: "Text To Voice" }), _jsxs("form", { onSubmit: (event) => {
                        event.preventDefault();
                        speak();
                    }, children: [_jsx(Input, { type: "text", value: text, onChange: (event) => setText(event.target.value), mt: 4, placeholder: "Enter some text here..." }), _jsx(Select, { cursor: "pointer", value: selectedVoice, onChange: handleVoiceSelectChange, mt: 2, children: voices.map((voice) => (_jsxs("option", { value: voice.name, children: [voice.name, " (", voice.lang, ")"] }, voice.name))) }), _jsxs(Box, { color: "pink.300", display: "flex", alignItems: "center", mt: 4, children: [_jsxs(Slider, { colorScheme: "pink", "aria-label": "Rate", value: rateSliderValue, onChange: handleRateSliderChange, flex: "1", children: [_jsx(SliderTrack, { children: _jsx(SliderFilledTrack, {}) }), _jsx(SliderThumb, {})] }), _jsx(Box, { ml: 2, minWidth: "40px", children: _jsx(Text, { children: "Speed" }) })] }), _jsxs(Box, { color: "pink.300", display: "flex", alignItems: "center", mt: 4, children: [_jsxs(Slider, { "aria-label": "Pitch", colorScheme: "pink", value: pitchSliderValue, onChange: handlePitchSliderChange, flex: "1", children: [_jsx(SliderTrack, { children: _jsx(SliderFilledTrack, {}) }), _jsx(SliderThumb, {})] }), _jsx(Box, { ml: 2, minWidth: "40px", children: _jsx(Text, { children: "Pitch" }) })] }), _jsx(Button, { type: "submit", mt: 4, colorScheme: "pink", children: "Speak" })] })] }) }));
};
