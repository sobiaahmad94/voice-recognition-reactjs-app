...
const Footer: React.FC = () => {
  return (
    <Container as="footer" borderRadius="7px" backgroundColor="blackAlpha.900" color="pink.300" padding={4} mt={8} borderTop="lightGrey">
      <Flex justify="center" align="center" fontSize="10px" >
